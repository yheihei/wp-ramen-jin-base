...
<article class="post-list-item">
	<a class="post-list-link" rel="bookmark" href="<?php echo esc_url( get_category_link( $featured_child_category->term_id ) ); ?>" itemprop='mainEntityOfPage'>
		<div class="post-list-inner">
			<div class="post-list-thumb" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
				<?php if ( ! is_mobile() ) : ?>
					...
					<?php else : ?>
						<img src="<?php echo esc_url( get_jin_noimage_url() ); ?>" width="480" height="270" alt="no image" />
			...
			<div class="post-list-meta vcard">
				<h2 class="post-list-title entry-title" itemprop="headline"><?php echo esc_html( $featured_child_category->name ); ?></h2>
			</div>
		</div>
	</a>
</article>
